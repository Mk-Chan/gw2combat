...
static inline skill GUARDIAN_GREATSWORD_1_1{
    .name = "Strike"_hs,
...
static inline skill GUARDIAN_GREATSWORD_1_2{
    .name = "Vengeful Strike"_hs,
    .type = skill::type::CASTING_NO_AFTER_CAST,
...
static inline skill GUARDIAN_GREATSWORD_1_3{
    .name = "Wrathful Strike"_hs,
    .type = skill::type::CASTING_NO_AFTER_CAST,
...
static inline skill GUARDIAN_GREATSWORD_2{
    .name = "Whirling Wrath"_hs,
...
static inline skill GUARDIAN_GREATSWORD_3{
    .name = "Leap of Faith"_hs,
    .type = skill::type::CASTING_NO_AFTER_CAST,
...
static inline skill GUARDIAN_GREATSWORD_5{
    .name = "Binding Blade"_hs,
...
static inline skill GUARDIAN_FOCUS_5{
    .name = "Shield of Wrath"_hs,
...
// Entity spawning skills
static inline skill GUARDIAN_GREATSWORD_4{
    .name = "Symbol of Resolution"_hs,
    .type = skill::type::CASTING_WITH_AFTER_CAST,
    .cast_duration = {360, 240},
    .cooldown = {12'000, 9'600},
};
static inline skill SWORD_OF_JUSTICE{
    .name = "Sword of Justice"_hs,
    .type = skill::type::CASTING_WITH_AFTER_CAST,
    .cast_duration = {900, 600},
    .cooldown = {20'000, 13'333},
};

// Spawned entity attack skills
static inline skill SYMBOL_OF_RESOLUTION_ATTACK{
    .name = "Symbol of Resolution Attack"_hs,
    .type = skill::type::CHANNELING_NO_AFTER_CAST,
...
static inline skill SWORD_OF_JUSTICE_ATTACK{
    .name = "Sword of Justice Attack"_hs,
    .type = skill::type::CHANNELING_NO_AFTER_CAST,

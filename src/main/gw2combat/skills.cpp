...
constexpr static inline skill SWORD_OF_JUSTICE{.name = "Sword of Justice"_hs,
                                               .type = skill::type::CASTING_WITH_AFTER_CAST,
                                               .cast_duration = {900, 600},
                                               .cooldown = {20'000, 13'333}};
constexpr static inline skill SWORD_OF_JUSTICE_ATTACK{.name = "Sword of Justice Attack"_hs,
                                                      .type = skill::type::CHANNELING_NO_AFTER_CAST,
